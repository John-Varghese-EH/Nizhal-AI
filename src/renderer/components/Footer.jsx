 ...
 * Required by FREE edition - shows creator credits
 */
    ...
    return (
        <footer className={`text-xs text-gray-500 text-center py-2 ${className}`}>
            <div className="flex items-center justify-center gap-2 flex-wrap">
                <span>Nizhal AI by</span>
                <button
                    onClick={() => openLink('https://github.com/John-Varghese-EH')}
                ...
                <span>|</span>
                <button
                    onClick={() => openLink('https://instagram.com/cyber__trinity')}
